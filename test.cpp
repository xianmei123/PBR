...
int main()
{
   ...
   // build and compile shaders
    // -------------------------
    Shader pbrShader("pbr/2.2.2.pbr.vs", "pbr/2.2.2.pbr.fs");
    Shader equirectangularToCubemapShader("pbr/2.2.2.cubemap.vs", "pbr/2.2.2.equirectangular_to_cubemap.fs");
    Shader irradianceShader("pbr/2.2.2.cubemap.vs", "pbr/2.2.2.irradiance_convolution.fs");
    Shader prefilterShader("pbr/2.2.2.cubemap.vs", "pbr/2.2.2.prefilter.fs");
    Shader brdfShader("pbr/2.2.2.brdf.vs", "pbr/2.2.2.brdf.fs");
    Shader backgroundShader("pbr/2.2.2.background.vs", "pbr/2.2.2.background.fs");
